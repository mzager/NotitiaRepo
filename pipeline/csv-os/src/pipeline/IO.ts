...
export class IO {
   ...
   */
  public static loadMetadata(inputStream: Highland.Stream<iTest>, omitFields: Array<string>): Promise<Highland.Stream<iTest>> {
   ...
   */
  public static WriteLog(uri: string, inputStream: Highland.Stream<iTest>): Promise<any> {
    return new Promise((resolve, reject) => {
  ...
  public static WriteProperty(uri: string, inputStream: Highland.Stream<iTest>, prop: string): Promise<any> {
    return new Promise((resolve, reject) => {
  ...
  public static WriteMeta(uri: string, inputStream: Highland.Stream<iTest>): Promise<any> {
    return new Promise((resolve, reject) => {
      const outputStream = fs.createWriteStream('./src/output/' + uri);
      outputStream.on('finish', () => resolve());
      outputStream.write('[');
      inputStream
        ...
        .map(v => {
          const obj: any = {};
          obj[v.data.name] = v.data.type === eDataType.Number ? v.data.values : v.data.values.string;
  ...
  public static WriteEvent(uri: string, inputStream: Highland.Stream<iTest>): Promise<any> {
    return new Promise((resolve, reject) => {
      const outputStream = fs.createWriteStream('./src/output/' + uri);
      outputStream.on('finish', () => resolve());
      outputStream.write('[');
  ...
  public static WriteMutation(uri: string, inputStream: Highland.Stream<iTest>): Promise<any> {
    return new Promise((resolve, reject) => {
      const outputStream = fs.createWriteStream('./src/output/' + uri);
      outputStream.on('finish', () => resolve());
      outputStream.write('[');
  ...
  public static WriteMatrix(uri: string, inputStream: Highland.Stream<iTest>): Promise<any> {
    return new Promise((resolve, reject) => {
      const outputStream = fs.createWriteStream('./src/output/' + uri);
      outputStream.on('finish', () => resolve());
      outputStream.write('[');
  ...
  public static WriteJson(uri: string, inputStream: Highland.Stream<iTest>): Promise<any> {
    return new Promise((resolve, reject) => {
      const outputStream = fs.createWriteStream('./src/output/' + uri);
      outputStream.on('finish', () => resolve());
      outputStream.write('[');

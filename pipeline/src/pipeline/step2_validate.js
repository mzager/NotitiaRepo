        ...
        return new Promise(function (resolve, reject) {
            ...
            IO_1.IO.loadMetadata(results, ['sample id', 'hgnc', 'variant']).then(function (metadata) {
                ...
                setTimeout(function (v) {
                    ...
                    Promise.all([
                        IO_1.IO.WriteLog(baseFileName + '.meta.log.json', results.observe()),
                        IO_1.IO.WriteJson(baseFileName + '.meta.raw.json', results)
        ...
        return new Promise(function (resolve, reject) {
            ...
            IO_1.IO.loadMetadata(results.fork(), ['patient id']).then(function (metadata) {
                var results = metadata
                    ...
                    .map(Test.metaDataType());
                // Write Meta Data
                IO_1.IO.WriteJson('patient.meta.raw.json', results.observe());
                IO_1.IO.WriteLog('patient.meta.log.json', results);
        ...
        return function (obj) {
            ...
            if (stringValues > 0 && numberValues > 0) {
                ...
                if (totalValues < 12) {
                    ...
                    obj.data.type =
                        stringValues === 0 ? InterfacesAndEnums_1.eDataType.Number : InterfacesAndEnums_1.eDataType.String;
                }
                else {

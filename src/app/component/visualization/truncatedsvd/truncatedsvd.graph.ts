...
export class TruncatedSvdGraph  extends AbstractVisualization {

        // Chart Elements
        private data: TruncatedSvdDataModel;
        private config: TruncatedSvdConfigModel;
        ...
        update(config: GraphConfig, data: any) {
            this.config = config as TruncatedSvdConfigModel;
            this.data = data;
            this.removeObjects();
            this.addObjects();
        }

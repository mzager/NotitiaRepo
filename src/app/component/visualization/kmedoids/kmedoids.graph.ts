...
import { KmedoidConfigModel, KmedoidDataModel } from './kmedoids.model';
import * as scale from 'd3-scale';
import * as _ from 'lodash';
import * as THREE from 'three';
import { ShapeEnum, GraphEnum } from 'app/model/enum.model';

export class KmedoidGraph implements ChartObjectInterface {
    ...
    private data: KmedoidDataModel;
    private config: KmedoidConfigModel;
    ...
    updateData( config: GraphConfig, data: any) {
        this.config = config as KmedoidConfigModel;
        this.data = data;
        this.removeObjects();
        this.addObjects();
    }

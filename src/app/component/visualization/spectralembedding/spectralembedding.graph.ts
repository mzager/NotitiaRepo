...
import { SpectralEmbeddingConfigModel, SpectralEmbeddingDataModel } from './spectralembedding.model';
...
export class SpectralEmbeddingGraph  extends AbstractVisualization {

        // Chart Elements
        private data: SpectralEmbeddingDataModel;
        private config: SpectralEmbeddingConfigModel;
        ...
        update(config: GraphConfig, data: any) {
            this.config = config as SpectralEmbeddingConfigModel;
            this.data = data;
            this.removeObjects();
            this.addObjects();
        }

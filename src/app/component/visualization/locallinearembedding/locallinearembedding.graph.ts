...
export class LocalLinearEmbeddingGraph  extends AbstractVisualization {

        // Chart Elements
        private data: LocalLinearEmbeddingDataModel;
        private config: LocalLinearEmbeddingConfigModel;
        ...
        update(config: GraphConfig, data: any) {
            this.config = config as LocalLinearEmbeddingConfigModel;
            this.data = data;
            this.removeObjects();
            this.addObjects();
        }

...
export class IsoMapGraph  extends AbstractVisualization {

        // Chart Elements
        private data: IsoMapDataModel;
        private config: IsoMapConfigModel;
        ...
        update(config: GraphConfig, data: any) {
            this.config = config as IsoMapConfigModel;
            this.data = data;
            this.removeObjects();
            this.addObjects();
        }

import { TsneDataModel, TsneConfigModel } from './tsne.model';
...
export class TsneGraph implements ChartObjectInterface {
    ...
    private data: TsneDataModel;
    private config: TsneConfigModel;
    ...
    update( config: GraphConfig, data: any) {
        this.config = config as TsneConfigModel;
        this.data = data;
        this.removeObjects();
        this.addObjects();
    }

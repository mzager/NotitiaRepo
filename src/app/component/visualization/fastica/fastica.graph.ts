...
export class FastIcaGraph  extends AbstractVisualization {

        // Chart Elements
        private data: FastIcaDataModel;
        private config: FastIcaConfigModel;
        ...
        update(config: GraphConfig, data: any) {
            this.config = config as FastIcaConfigModel;
            this.data = data;
            this.removeObjects();
            this.addObjects();
        }

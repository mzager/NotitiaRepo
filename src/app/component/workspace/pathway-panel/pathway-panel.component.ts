...
<div class="geneset-modal-panel">
        <div class="row">
                ...
                <div class="col s12">
                        <h1 class='geneset-h1'>Pathways</h1>

                        <h2 class='geneset-h2'>Select from thousands of curated pathways
        ...
        <div class='col s12 l3 geneset-my-list'>
            ...
            <div *ngFor='let myPathway of pathways' (click)='pathwayDel(myPathway)'>
                <div class='geneset-my-row'>
                    ...
                    <span class='geneset-my-name'>{{myPathway.n}}</span>
                </div>
            </div>
        </div>
        <div class='col s12 l9 geneset-public-datasets'>
            <span class="geneset-public-span">Select a Pathway</span>
            <!-- From -->
            <div class='col s12 geneset-from-field'>
                <label class=' geneset-from-label'>From</label>
                <select
                    class='geneset-categories-dropdown browser-default' materialize='material_select'
            ...
            <!-- Curated -->
            <span>
                <div class='col s12 geneset-where-field'>
                ...
                <div>
                    <div *ngFor='let option of pathwayOptionsFilter'
                        (click)='pathwayAdd(option)'class='geneset-results' >

import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, EventEmitter, Output, Renderer, ViewChild, ViewEncapsulation } from "@angular/core";
...
export class UploadPanelComponent {
  ...
  uploadFile(): void {
    this.renderer.invokeElementMethod(this.fileInput.nativeElement, "dispatchEvent", [new MouseEvent("click", { bubbles: true })]);
  }

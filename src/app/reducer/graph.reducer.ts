...
import { COMPUTE_BOX_WHISKERS_COMPLETE, COMPUTE_CHROMOSOME_COMPLETE, COMPUTE_DA_COMPLETE, COMPUTE_DENDOGRAM_COMPLETE, COMPUTE_DE_COMPLETE, COMPUTE_DICTIONARY_LEARNING_COMPLETE, COMPUTE_FAST_ICA_COMPLETE, COMPUTE_FA_COMPLETE, COMPUTE_GENOME_COMPLETE, COMPUTE_HAZARD_COMPLETE, COMPUTE_HEATMAP_COMPLETE, COMPUTE_HIC_COMPLETE, COMPUTE_ISO_MAP_COMPLETE, COMPUTE_LDA_COMPLETE, COMPUTE_LINKED_GENE_COMPLETE, COMPUTE_LOCAL_LINEAR_EMBEDDING_COMPLETE, COMPUTE_MDS_COMPLETE, COMPUTE_NMF_COMPLETE, COMPUTE_NONE_COMPLETE, COMPUTE_PARALLEL_COORDS_COMPLETE, COMPUTE_PATHWAYS_COMPLETE, COMPUTE_PCA_COMPLETE, COMPUTE_PCA_INCREMENTAL_COMPLETE, COMPUTE_PCA_KERNAL_COMPLETE, COMPUTE_PCA_SPARSE_COMPLETE, COMPUTE_PLSR_COMPLETE, COMPUTE_SOM_COMPLETE, COMPUTE_SPECTRAL_EMBEDDING_COMPLETE, COMPUTE_SURVIVAL_COMPLETE, COMPUTE_TIMELINES_COMPLETE, COMPUTE_TRUNCATED_SVD_COMPLETE, COMPUTE_TSNE_COMPLETE } from './../action/compute.action';

...
import { LocalLinearEmbeddingConfigModel, LocalLinearEmbeddingDataModel
...
import { DictionaryLearningConfigModel, DictionaryLearningDataModel
...
export class SvmAction implements Action {
    ...
    constructor(public payload: {graph: GraphEnum, samples: Array<string>, genes: Array<string>,

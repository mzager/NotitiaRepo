...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://1yp2obcfme.execute-api.us-west-2.amazonaws.com/prod';
    ...
    apigClient.permissionsPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var permissionsPostRequest = {
        ...
        return apiGatewayClient.makeRequest(permissionsPostRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.projectsDelete = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        ...
        return apiGatewayClient.makeRequest(projectsDeleteRequest, authType, additionalParams, config.apiKey);
    };
